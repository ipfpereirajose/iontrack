...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    { name: 'Validación Dosis', href: '/validation', icon: ClipboardCheck },
    { name: 'Reportes y Certificados', href: '/reports', icon: FileText },
  ];

  return (
    <aside className="sidebar">
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
        <Link href="/" style={{ fontSize: '1.25rem', fontWeight: 800, color: 'white', textDecoration: 'none' }}>
