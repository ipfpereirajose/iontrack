import { Globe, Server, FileWarning } from "lucide-react";
import { SecuritySentinel } from "@/lib/security_sentinel";

export default async function TelemetryDashboardWidgets() {
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style={{ padding: "1.25rem 1.5rem" }}>
                  <span className="badge badge-warning" style={{ background: "rgba(239, 68, 68, 0.1)", color: "var(--danger)" }}>
                    Desconectado
                  </span>
                </td>
              </tr>
