...
import { deleteCompanyUser } from "@/app/lab/users/actions";

export default async function ActiveAccountsWidget({ tenantId, totalCompanies }: { tenantId: string, totalCompanies: number }) {
