import { Shield, Building2, Save, History, User, Lock, Mail, Phone, MapPin, AlertCircle } from 'lucide-react';
  ...
  return (
    <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
      <header style={{ marginBottom: '3rem' }}>
        <h1 style={{ fontSize: '2.5rem', fontWeight: 900, marginBottom: '0.5rem' }}>Configuración de Empresa</h1>
        <p style={{ color: 'var(--text-muted)' }}>Gestione su información institucional y datos de contacto.</p>
      </header>
