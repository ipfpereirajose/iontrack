    ...
    <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
      <header style={{ marginBottom: "3rem" }}>
        ...
        <p style={{ color: "var(--text-muted)" }}>
          Acceda a sus certificados oficiales, reportes mensuales y
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              Descargue los certificados individuales validados de su personal
              expuesto (TOE).
            </p>
          </div>
          <button
            className="btn btn-primary"
            style={{ marginTop: "auto", gap: "0.75rem" }}
          >
        ...
        >
          ...
          <div>
            ...
            >
              Reportes consolidados de la empresa por mes y año en formato
              Excel/PDF.
            </p>
          </div>
          <button
            className="btn"
            style={{ marginTop: "auto", background: "#f1f5f9", gap: "0.75rem" }}
          >
        ...
        >
          ...
          <div>
            ...
            >
              Guías de usuario, normativas de protección radiológica y
