    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1.5rem', marginBottom: '3rem' }}>
        <div className="clean-panel">
          ...
          <div className="badge badge-success" style={{ marginTop: '0.5rem' }}>Operativo</div>
        </div>
        ...
        <div className="clean-panel">
          ...
          <div className="badge badge-success" style={{ marginTop: '0.5rem' }}>+12% vs mes ant.</div>
        </div>
        ...
        <div className="clean-panel">
          ...
          <div className="badge badge-success" style={{ marginTop: '0.5rem' }}>Uptime Estable</div>
        </div>
      ...
      <section style={{ marginTop: '3rem' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
          ...
          <Link href="/admin/tenants" style={{ fontSize: '0.875rem', color: 'var(--primary-teal)', textDecoration: 'none', fontWeight: 600 }}>Ver todos →</Link>
        </div>
              ...
              <tbody>
                {tenants.map((tenant) => (
                  <tr key={tenant.id}>
                    ...
                    <td style={{ color: 'var(--text-muted)', fontSize: '0.875rem' }}>{tenant.slug}</td>
                    <td>
                    ...
                    <td style={{ fontWeight: 700 }}>${Number(tenant.monthly_fee).toLocaleString()}</td>
