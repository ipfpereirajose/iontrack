        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            ...
            <select 
              ...
              style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid var(--border-glass)', borderRadius: '8px', padding: '0.75rem 1rem', color: 'white', outline: 'none' }}
            >
              <option value="active" style={{ background: '#1e293b' }}>Activo (Acceso Total)</option>
              <option value="past_due" style={{ background: '#1e293b' }}>Pago Pendiente</option>
              <option value="suspended" style={{ background: '#1e293b' }}>Suspendido (Sin Acceso)</option>
            </select>
          </div>
        </div>
