    ...
    <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
      <header style={{ marginBottom: "2.5rem" }}>
        ...
        <p style={{ color: "var(--text-muted)" }}>
          Complete todos los campos para dar de alta una nueva entidad en la
      ...
      >
          ...
          >
            <div className="input-group">
              ...
              <input
                name="name"
                required
                placeholder="Ej: Laboratorio Central de Dosimetría"
                style={inputStyle}
              />
            </div>
            <div className="input-group">
            ...
            <div className="input-group" style={{ gridColumn: "span 2" }}>
              ...
              <textarea
                name="address"
                required
                placeholder="Dirección completa detallada..."
          ...
          >
            ...
            <div className="input-group" style={{ gridColumn: "span 2" }}>
              ...
              <input
                ...
                required
                type="email"
                placeholder="correo.representante@ejemplo.com"
                style={inputStyle}
              />
            </div>
          </div>
        ...
        <section className="glass-panel" style={{ padding: "2.5rem" }}>
          ...
          >
            ...
            <h2 style={{ fontSize: "1.25rem", fontWeight: 800 }}>
              Contacto y Credenciales de Acceso
            </h2>
          </div>
          ...
          >
            ...
            <div className="input-group" style={{ gridColumn: "span 2" }}>
              ...
              >
                <Info size={14} />
                Se enviará un enlace de verificación y asignación de contraseña
                a esta dirección.
              </p>
            </div>
          </div>
