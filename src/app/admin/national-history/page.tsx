    ...
    <div>
      <header style={{ marginBottom: "2.5rem" }}>
        ...
        <p style={{ color: "var(--text-muted)" }}>
          Consolidación de exposición radiológica por Cédula de Identidad a
          nivel nacional.
        </p>
      </header>
            ...
            <tbody>
              {records?.map((record: any) => (
                <tr key={record.ci}>
                  ...
                  <td>
                    <Link
                      href={`/admin/national-history/${record.ci}`}
                      className="btn"
                      style={{ padding: "0.4rem", background: "#f1f5f9" }}
                    >
