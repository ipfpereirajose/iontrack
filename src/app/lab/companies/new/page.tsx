...
export default function NewCompanyPage() {
  ...
  useEffect(() => {
    if (selectedEstado) {
      const estadoObj = venezuelaData.find((e: any) => e.estado === selectedEstado);
  ...
  useEffect(() => {
    if (selectedMunicipio) {
      const municipioObj = municipios.find((m: any) => m.municipio === selectedMunicipio);
  ...
  return (
    <div style={{ maxWidth: '1000px', margin: '0 auto', paddingBottom: '5rem' }}>
      <header style={{ marginBottom: '2.5rem' }}>
        <Link href="/lab/companies" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', color: 'var(--text-muted)', textDecoration: 'none', marginBottom: '1.5rem', fontSize: '0.875rem', fontWeight: 600 }}>
          <ArrowLeft size={16} />
          Volver a Empresas
        </Link>
        <h1 style={{ fontSize: '2.5rem', fontWeight: 900, marginBottom: '0.5rem', letterSpacing: '-0.02em' }}>Registro de Entidad</h1>
        <p style={{ color: 'var(--text-muted)', fontSize: '1.1rem' }}>Complete la información detallada de la nueva empresa cliente.</p>
      </header>
      ...
      <form action={clientAction} style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
        ...
        <div className="glass-panel" style={{ padding: '2.5rem', borderRadius: '24px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '1.5rem', marginBottom: '1.5rem' }}>
            <div>
              ...
              <input required name="name" type="text" placeholder="RAZÓN SOCIAL COMPLETA" style={inputStyle} />
            </div>
            <div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr 2fr', gap: '1.5rem' }}>
            ...
            <div>
              ...
              <input required name="rif_number" type="text" placeholder="Ej: 123456789" style={inputStyle} />
            </div>
            <div>
        ...
        <div className="glass-panel" style={{ padding: '2.5rem', borderRadius: '24px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.5rem', marginBottom: '1.5rem' }}>
            ...
            <div>
              ...
              >
                <option value="">{selectedEstado ? 'Seleccione un Municipio...' : 'Seleccione primero el Estado'}</option>
            ...
            <div>
              ...
              >
                <option value="">{selectedMunicipio ? 'Seleccione una Parroquia...' : 'Seleccione primero el Municipio'}</option>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr', gap: '1.5rem' }}>
            <div>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <input name="company_email" type="email" placeholder="contacto@empresa.com" style={{ ...inputStyle, paddingLeft: '2.75rem' }} />
              </div>
            </div>
            <div>
              <label style={labelStyle}>Telf Local</label>
              <input name="local_phone" type="text" placeholder="Ej: 0212-1234567" style={inputStyle} />
            </div>
            <div>
              <label style={labelStyle}>Telf Móvil *</label>
              <input required name="mobile_phone" type="text" placeholder="Ej: 0414-1234567" style={inputStyle} />
            </div>
          </div>
        </div>
        ...
        <div className="glass-panel" style={{ padding: '2.5rem', borderRadius: '24px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem', marginBottom: '1.5rem' }}>
            <div>
              ...
              <input required name="osr_first_name" type="text" placeholder="NOMBRES DEL OFICIAL" style={inputStyle} />
            </div>
            <div>
              <label style={labelStyle}>Apellidos OSR *</label>
              <input required name="osr_last_name" type="text" placeholder="APELLIDOS DEL OFICIAL" style={inputStyle} />
            </div>
          </div>

          <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr 2fr 2fr', gap: '1.5rem' }}>
            <div>
            ...
            <div>
              ...
              <input required name="osr_id_number" type="text" placeholder="12345678" style={inputStyle} />
            </div>
            <div>
              <label style={labelStyle}>Telf OSR *</label>
              <input required name="osr_phone" type="text" placeholder="0414-0000000" style={inputStyle} />
            </div>
            <div>
              <label style={labelStyle}>Email OSR *</label>
              <input required name="osr_email" type="email" placeholder="osr@correo.com" style={inputStyle} />
            </div>
          </div>
        </div>

        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '1rem', marginTop: '1rem' }}>
          <button type="reset" className="btn" style={{ background: 'rgba(255,255,255,0.05)', padding: '0.75rem 1.5rem', borderRadius: '12px', fontWeight: 600 }}>
            Limpiar Formulario
          </button>
          <SubmitButton />
        </div>
