...
import { FileText, Download, Calendar, ShieldCheck, ClipboardList, Send } from 'lucide-react';
  ...
  return (
    <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
      <header style={{ marginBottom: '3rem' }}>
        <h1 style={{ fontSize: '2.5rem', fontWeight: 900, marginBottom: '0.5rem' }}>Reportes y Certificados</h1>
        <p style={{ color: 'var(--text-muted)', fontSize: '1.1rem' }}>Gestión de reportes oficiales para clientes y autoridades reguladoras.</p>
      </header>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr', gap: '2.5rem' }}>
        ...
        <section className="clean-panel">
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
            <div style={{ padding: '0.75rem', background: 'rgba(0, 168, 181, 0.1)', borderRadius: '12px' }}>
              <ShieldCheck size={24} color="var(--primary-teal)" />
            </div>
            <div>
              <h2 style={{ fontSize: '1.25rem', fontWeight: 800 }}>Reportes para la Autoridad</h2>
              <p style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>Exportación masiva de dosis mensuales.</p>
            </div>
          </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          <section className="clean-panel">
            <h3 style={{ fontSize: '1rem', fontWeight: 800, marginBottom: '1.5rem' }}>Otros Documentos</h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
...
const labelStyle = { display: 'block', fontSize: '0.7rem', fontWeight: 900, color: 'var(--text-muted)', textTransform: 'uppercase', marginBottom: '0.5rem' } as any;
const inputStyle = { 
  width: '100%', 
